"""
A modification of the `ExactInference` module in `pgmpy`. Modified to track
the time the elimination step inside VariableElimination takes, and returns
the total time.
"""
...
class VariableElimination(Inference):
    ...
    def query(self, variables, evidence=None, elimination_order="MinFill", joint=True, stopwatch=True):
        """
        Parameters
        ----------
        variables: list
